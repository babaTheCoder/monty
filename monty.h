...
/**
 * struct strack_s - doubly linked list representation of a stack (or queue)
 * @n: integer
 * @prev: points to the previous element of thee stack (or queue)
 ...
 * @line_number: the current line of the opcode is the file.
 * @stack: the head of the stack which the opcode is operates on.
 * @mode: The current mode of stack opcodes oprate on.
